...
with open("data/df_dados_macro_regioes_ceara.csv", "w", newline="", encoding="utf-8") as csv_file:
...
with open("data/df_dados_macro_regioes_bahia.csv", "w", newline="", encoding="utf-8") as csv_file:
    csv_writer = csv.writer(csv_file)
    csv_writer.writerow(columns)
