                ...
                with div(cls="col text-primary"):
                    ...
                    with div(cls="row m-3 justify-content-around"):
                        with div(cls="col d-flex justify-content-center"):
                            raw(macro_fig_ce.to_html(full_html=False, include_plotlyjs="cdn"))
                    with div(cls="row m-3 justify-content-around"):
                        with div(cls="col d-flex justify-content-center"):
                            raw(macro_fig_ce_ob.to_html(full_html=False, include_plotlyjs=False))
                    with div(cls="row m-3 justify-content-around"):
                        with div(cls="col d-flex justify-content-center"):
                            raw(macro_fig_ba.to_html(full_html=False, include_plotlyjs=False))
                    with div(cls="row m-3 justify-content-around"):
                        with div(cls="col d-flex justify-content-center"):
                            raw(macro_fig_ba_ob.to_html(full_html=False, include_plotlyjs=False))
